...
Resources related to authentication in Auth0 API
...
## Client javascript [/client/auth0mockapiclientid.js]

### Return dummy javascript to prevent 404-error in console [GET]
